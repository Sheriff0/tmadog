...
def gui_getcookie(default = None, attr = None, queue = DummyQueue(), cb = None, cookie_client = None):
...
def gui_start(parser, pkg_name, logger, *argv, **kwargs):
    ...
    getcookie = gui_getcookie(default = args, attr = "cookies", queue = queue, cb = update_cookie, cookie_client = cookie_client);
